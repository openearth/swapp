 ...
 */
 ...
 // EXTRA FUNCTION: generate mongoDB query based on LocationFilter selection
 function generateAreaQuery(bounds) {
    ...
    // Generate a query for mongodb, based on a polygon
    var query = {		
        "data.geometry": {
            "$geoWithin": {                
                "$polygon": [[w,s],[w,n],[e,n],[e,s]]                           
            }
        }
    };
    return query;
